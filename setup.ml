...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7f506d34c21caa4de5ee270568c03c67) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          copyrights = [];
          maintainers = [];
          authors = ["Tony Aldridgew <tony@angry-lawyer.com>"];
          homepage = None;
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [FindlibPackage ("compiler-libs.commin", None)];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Ü\134|ÂÍh:\136íj°\023\\ýÀ@";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
