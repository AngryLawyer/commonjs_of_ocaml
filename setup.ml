...
(* OASIS_START *)
(* DO NOT EDIT (digest: 77a814f2d5e4b19b203c30a60aa25880) *)
(*
...
let setup_t =
  {
                      ...
                      (OASISExpr.EBool true,
                        ("ocamlbuild",
                          [
                             ...
                             "\\\n&&";
                             "js_of_ocaml";
                             "_build/test/ocaml_required.byte";
                             "\\\n&&";
                             "mv";
                             "_build/test/ocaml_required.js";
                             "test";
                             "\\\n&&";
                             "cd";
                             "test";
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/angrylawyer/commonjs_of_ocaml";
          synopsis = "Import and export CommonJS modules in js_of_ocaml";
          description =
            Some
              [
                 OASISText.Para
                   "Helper PPX and functions for ease of interfacing with other CommonJS modules when building a project through js_of_ocaml"
              ];
          categories = [];
               ...
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$ocamlfind",
                           ["install"; "commonjs_ppx"; "lib/ppx/META"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "commonjs_ppx"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
               ...
               Test
                 ({
                  ...
                  },
                   {
                      ...
                      test_tools = [InternalExecutable "commonjs_ppx"]
                   });
               SrcRepo
                 ({
                     cs_name = "master";
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/angrylawyer/commonjs_of_ocaml.git";
                      src_repo_browser =
                        Some
                          "https://github.com/angrylawyer/commonjs_of_ocaml";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\205.S\b\203\252\191 9:\232\006X\226\237\140";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
